...
mixin _$ImageRef {
 ...
 ImageSourceKind get kind; String get value;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ImageRef&&(identical(other.kind, kind) || other.kind == kind)&&(identical(other.value, value) || other.value == value));
}
...
@override
String toString() {
  return 'ImageRef(kind: $kind, value: $value)';
}
...
@useResult
$Res call({
 ImageSourceKind kind, String value
});
...
as ImageSourceKind,value: null == value ? _self.value : value // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( ImageSourceKind kind,  String value)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ImageRef() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( ImageSourceKind kind,  String value)  $default,) {final _that = this;
switch (_that) {
case _ImageRef():
return $default(_that.kind,_that.value);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( ImageSourceKind kind,  String value)?  $default,) {final _that = this;
switch (_that) {
case _ImageRef() when $default != null:
return $default(_that.kind,_that.value);case _:
  return null;
...
class _ImageRef extends ImageRef {
  const _ImageRef({this.kind = ImageSourceKind.asset, this.value = ''}): super._();
  factory _ImageRef.fromJson(Map<String, dynamic> json) => _$ImageRefFromJson(json);

@override@JsonKey() final  ImageSourceKind kind;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ImageRef&&(identical(other.kind, kind) || other.kind == kind)&&(identical(other.value, value) || other.value == value));
}
